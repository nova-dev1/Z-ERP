  ...
  return (
    <div style={{ padding: "28px 32px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, marginBottom: 20, flexWrap: "wrap" }}>
        ...
        <button onClick={handleExcel} style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", border: `1px solid ${darkMode ? "#3A3A3A" : "#E5E7EB"}`, borderRadius: 8, background: card, color: text, fontSize: 13, cursor: "pointer", fontWeight: 500 }}>
                ...
                {filtered.length === 0 ? (
                  ...
                  return (
                    <tr key={o.id} style={{ borderBottom: `1px solid ${border}` }}>
                      <td style={{ padding: "13px 16px", fontWeight: 600, color: text, whiteSpace: "nowrap" }}>{o.code}</td>
                      ...
                      <td style={{ padding: "13px 16px" }}>
                        <div style={{ display: "flex", gap: 5 }}>
                          <button onClick={() => generateInvoicePDF(o)} title="Générer PDF"
                            style={{ padding: "4px 8px", background: "#C8F000", border: "none", borderRadius: 6, cursor: "pointer", display: "flex", alignItems: "center", gap: 4, fontSize: 11, fontWeight: 600, color: "#1C1C1C" }}>
